...
public class Customer extends User {
	...
	@JoinTable(name = "cus_Acc_tbl", joinColumns = @JoinColumn(name = "userId"))
	private List<Account> account;

	public Customer(int userId, String fullName, String userName, String passWord, long phoneNumber, Status status) {
